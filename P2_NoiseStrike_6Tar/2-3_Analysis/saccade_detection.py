...
def vecvel(x, SAMPLING, TYPE=2):
    ...
    input:
    x = pandas data frame with 2 colums, first for x, second for y position
    SAMPLING = the smpling rate of the eye tracker
...
def saccades(x, VFAC=5, MINDUR=8, SAMPLING=1000):
    """
    saccade detection function based on Engbert and Mergethaler 2014
